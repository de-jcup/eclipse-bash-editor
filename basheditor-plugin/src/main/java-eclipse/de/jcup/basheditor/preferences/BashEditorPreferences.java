...
public class BashEditorPreferences {
    ...
    public boolean isAutomaticLaunchInExternalTerminalEnabled() {
        return getBooleanPreference(P_LAUNCH_IN_TERMINAL_ENABLED);
    }

    public boolean isShowMetaInfoInDebugConsoleEnabled() {
        return getBooleanPreference(P_SHOW_META_INFO_IN_DEBUG_CONSOLE);
    }

    public String getTerminalCommand() {
        return getStringPreference(P_LAUNCH_TERMINAL_COMMAND);
    }

    public String getStarterCommand() {
        return getStringPreference(P_LAUNCH_STARTER_COMMAND);
    }

    public String getJustOpenTerminalCommand() {
        return getStringPreference(P_JUST_OPEN_TERMINAL_COMMAND);
    }

    public boolean isLaunchedTerminalWaitingOnErrors() {
        return getBooleanPreference(P_KEEP_TERMINAL_OPEN_ON_ERRORS);
    }

    public boolean isLaunchedTerminalAlwaysWaiting() {
        return getBooleanPreference(P_KEEP_TERMINAL_OPEN_ALWAYS);
    }
    ...
    public boolean isSharedModelBuildEnabled() {
        return getBooleanPreference(P_SHARED_MODEL_ENABLED);
    }
    ...
    public String getCustomScriptPathToUserHome() {
        return getStringPreference(P_USER_HOME_CUSTOMPATH);
    }
