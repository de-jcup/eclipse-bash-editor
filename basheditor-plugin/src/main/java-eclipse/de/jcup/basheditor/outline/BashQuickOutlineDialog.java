...
import de.jcup.basheditor.AbstractFilterableTreeQuickDialog;
import de.jcup.basheditor.AbstractTreeViewerFilter;
import de.jcup.basheditor.BashEditor;
import de.jcup.basheditor.BashEditorActivator;
import de.jcup.basheditor.FilterPatternMatcher;
 ...
 *
 */
public class BashQuickOutlineDialog extends AbstractFilterableTreeQuickDialog<Item> {
	 ...
	 */
	public BashQuickOutlineDialog(IAdaptable adaptable, Shell parent, String infoText) {
		super(adaptable, parent, "Bash quick outline", MIN_WIDTH, MIN_HEIGHT, infoText);
		this.editor = adaptable.getAdapter(BashEditor.class);
	}
